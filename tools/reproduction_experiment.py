...
from runtime.data_miner import DataMiner
from runtime.hypothesis_tester import HypothesisTester, Hypothesis, HypothesisStatus
...
async def experiment_galaxy_classification():
    ...
    for g in galaxy_features_raw:
        ...
        from runtime.data_miner import ExtractedFeatures
