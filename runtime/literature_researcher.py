...
class Paper:
    ...
    def to_dict(self) -> Dict:
        return {
            ...
            "published": self.published_date[:10],
...
class VectorStoreInterface:
    ...
    async def add_papers(self, papers: List[Paper]) -> bool:
        ...
        Returns:
            bool: 是否成功
        """
        raise NotImplementedError("Subclasses must implement add_papers")
    ...
    async def delete_paper(self, paper_id: str) -> bool:
        ...
        Returns:
            bool: 是否成功
        """
        raise NotImplementedError("Subclasses must implement delete_paper")
    ...
    async def get_collection_stats(self) -> Dict[str, Any]:
        ...
        Returns:
            Dict: 统计信息
        """
        raise NotImplementedError("Subclasses must implement get_collection_stats")
...
class LiteratureResearcher:
    ...
    def _analyze_gaps_advanced(self, papers: List[Paper],
        ...
        all_text = ' '.join(titles_lower + abstracts_lower)
...
"""
    ...
    async def generate_hypotheses(self, state: ResearchState) -> List[ResearchHypothesis]:
        ...
        for gap in state.research_gaps:
            ...
            if gap.category == "methodology":
                ...
                hypotheses.append(ResearchHypothesis(
                    id=f"hyp-{hyp_id}",
                    hypothesis=f"如果建立统一评估基准，那么可以更客观地比较不同方法的优劣",
    ...
    async def generate_review(self, topic: str, max_papers: int = 50) -> LiteratureReview:
        ...
        # 观测站联动
        obs_link = self.link_to_observatory(research_state)
