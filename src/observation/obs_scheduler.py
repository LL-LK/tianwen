...
class AstronomicalCalculator:
    ...
    def compute_moon_position(self, time: datetime) -> Tuple[float, float, float]:
        ...
        _ = math.radians(moon_mean_anomaly)
        ...
        # 月亮照明度
        _ = (1 - math.cos(2 * math.pi * moon_phase)) / 2
    ...
    def compute_moon_distance_and_phase(
        ...
        # 计算角距离
        _ = math.radians(target_alt - moon_alt)
...
def run_demo():
    ...
    for astro_window in astronomical_windows[:1]:
        # 假设调度了2个目标
        _ = astro_window.start + (astro_window.end - astro_window.start) / 2
